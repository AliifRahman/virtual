      ...
      <div className="row">
        <div className="col-xl-3 col-sm-6 mb-3">
          <div className="card dashboard text-white bg-primary o-hidden h-100">
            ...
            <Link className="card-footer text-white clearfix small z-1" to="/messageadmin">
        ...
        <div className="col-xl-3 col-sm-6 mb-3">
          <div className="card dashboard text-white bg-warning o-hidden h-100">
            ...
            <Link className="card-footer text-white clearfix small z-1" to="/reviewsadmin">
              <span className="float-left">View Details</span>
              <span className="float-right">
                <i className="fa fa-angle-right" />
              </span>
        ...
        <div className="col-xl-3 col-sm-6 mb-3">
          <div className="card dashboard text-white bg-success o-hidden h-100">
            ...
            <Link className="card-footer text-white clearfix small z-1" to="/bookingadmin">
              <span className="float-left">View Details</span>
              <span className="float-right">
                <i className="fa fa-angle-right" />
              </span>
        ...
        <div className="col-xl-3 col-sm-6 mb-3">
          <div className="card dashboard text-white bg-danger o-hidden h-100">
            ...
            <Link className="card-footer text-white clearfix small z-1" to="/bookmarksadmin">
              <span className="float-left">View Details</span>
              <span className="float-right">
                <i className="fa fa-angle-right" />
              </span>

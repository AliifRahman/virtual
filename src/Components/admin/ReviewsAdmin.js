      ...
      <div className="list_general reviews">
        <ul>
          <li>
            ...
            <span className="rating"><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star" /></span>
            ...
            <p className="inline-popups"><Link href="#modal-reply" data-effect="mfp-zoom-in" className="btn_1 gray"><i className="fa fa-fw fa-reply" /> Reply to this review</Link></p>
          </li>
          <li>
            <span>June 15 2017</span>
            <span className="rating"><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star yellow" /><i className="fa fa-fw fa-star" /><i className="fa fa-fw fa-star" /></span>
    ...
    <nav aria-label="...">
      <ul className="pagination pagination-sm add_bottom_30">
        <li className="page-item disabled">
          <Link className="page-link" to="/reviewsadmin" tabIndex={-1}>Previous</Link>
        </li>
        <li className="page-item"><a className="page-link" to="/reviewsadmin">1</a></li>
        <li className="page-item"><a className="page-link" to="/reviewsadmin">2</a></li>
        <li className="page-item"><a className="page-link" to="/reviewsadmin">3</a></li>
        <li className="page-item">
          <Link className="page-link" to="/reviewsadmin">Next</Link>
        </li>
      </ul>
    </nav>
    {/* /pagination*/}

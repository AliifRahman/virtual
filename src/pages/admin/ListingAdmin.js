  ...
  <div className="container-fluid">
    ...
    <div className="box_general">
      <div className="header_box">
        <h2 className="d-inline-block">Listings</h2>
      ...
      <div className="list_general">
        <ul>
          <li>
            ...
            <p><Link to="/listingadmin" className="btn_1 gray"><i className="fa fa-fw fa-eye" /> View item</Link></p>
            <ul className="buttons">
              <li><Link to="/listingadmin" className="btn_1 gray delete wishlist_close"><i className="fa fa-fw fa-times-circle-o" /> Cancel</Link></li>
            </ul>
          </li>
          <li>
    ...
    <nav aria-label="...">
      <ul className="pagination pagination-sm add_bottom_30">
        <li className="page-item disabled">
          <Link className="page-link" to="/listingadmin" tabIndex={-1}>Previous</Link>
        </li>
        <li className="page-item"><a className="page-link" to="/listingadmin">1</a></li>
        <li className="page-item"><a className="page-link" to="/listingadmin">2</a></li>
        <li className="page-item"><a className="page-link" to="/listingadmin">3</a></li>
        <li className="page-item">
          <Link className="page-link" to="/listingadmin">Next</Link>
        </li>
      </ul>
    </nav>
    {/* /pagination*/}

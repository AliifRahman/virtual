      ...
      <div className="list_general">
        <ul>
          <li>
            ...
            <p><Link to="/" className="btn_1 gray"><i className="fa fa-fw fa-envelope" /> Send Message</Link></p>
            <ul className="buttons">
              <li><Link to="/" className="btn_1 gray approve"><i className="fa fa-fw fa-check-circle-o" /> Approve</Link></li>
              <li><Link href="#0" className="btn_1 gray delete"><i className="fa fa-fw fa-times-circle-o" /> Cancel</Link></li>
            </ul>
          </li>
          <li>
            <figure><img src="img/item_2.jpg" alt /></figure>
            <h4>Da Alfredo <i className="cancel">Cancelled</i></h4>
            <ul className="booking_list">
          ...
          <li>
            ...
            <h4>Pompidue Museum <i className="approved">Approved</i></h4>
            <ul className="booking_list">
              <li><strong>Booking date</strong> 11 November 2017</li>
              <li><strong>Booking details</strong> 2 People</li>
              <li><strong>Client</strong> Mark Twain</li>
    ...
    <nav aria-label="...">
      <ul className="pagination pagination-sm add_bottom_30">
        <li className="page-item disabled">
          <Link className="page-link" to="/bookingadmin" tabIndex={-1}>Previous</Link>
        </li>
        <li className="page-item"><Link className="page-link" to="/bookingadmin">1</Link></li>
        <li className="page-item"><Link className="page-link" to="/bookingadmin">2</Link></li>
        <li className="page-item"><Link className="page-link" to="/bookingadmin">3</Link></li>
        <li className="page-item">
          <Link className="page-link" to="/bookingadmin">Next</Link>
        </li>
      </ul>
    </nav>
  </div>

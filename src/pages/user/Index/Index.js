...
function Index(props) {
    ...
    document.writeln("<script type='text/javascript' src='assets/user/js/jquery.flexslider.js'></script>");
    document.writeln("<script type='text/javascript' src='assets/user/js/swiper-bundle.min.js'></script>");
    document.writeln("<script type='text/javascript' src='assets/user/js/CustomHome.js'></script>");
